...
<form method='post' action='cancel_list1.php'>
...
<tr>
	<td colspan=2 align='center'><b>Cancel Ticket</b></td>
</tr>
<tr>
...
<tr>
	<td align='center' colspan=2><input type='submit' value='Cancel' style='font-size:16px;font-weight:bold;color:white;background-color:red;text-shadow:2px 2px 2px black;'></td>
</tr>
</table>
</form>
</body>
